...
<%--
		 ...
		 JSP => HTML / CSS / JavaScript / Java / Oracle연동
		   ...
		   3. JSP => 사용법
    		   ...
    		   Object page = this;
		         ...
		         ------------------------- 9개 사용이 가능
		         미리 객체를 생성한 다음에 필요시마다 사용이 가능하게 만든다.
 ...
 <%--
 		...
 		public void_jspService(final jakarta.servlet.http.HttpServletRequest request, 
		       HttpServletResponse response)
		  {
		       PageContext pageContext;
    		   http.HttpSession session = null;
